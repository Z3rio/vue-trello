  ...
  <div class="dashboard-container">
    <div class="left-container">
      <v-btn
        ...
        plain
        block
        ><v-icon size="16"> mdi-clipboard-outline </v-icon>Boards</v-btn
      >
      <v-btn
        ...
        plain
        block
        ><v-icon size="16"> mdi-clipboard-edit-outline </v-icon>Templates</v-btn
      >
      <v-btn
        ...
        plain
        block
        ><v-icon size="16"> mdi-chart-timeline-variant </v-icon>Home</v-btn
      >
      <hr />
      ...
      <WorkspaceInfo
        v-for="(data, index) in workspaces"
        :key="index"
        :data="data"
      />
    </div>
