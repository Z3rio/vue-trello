...
<template>
  <div class="footer-cont">
      ...
      <div class="first">
        ...
        >
          ...
          >
            ...
            <stop offset=".15" stop-color="#fff" stop-opacity=".65"></stop>
            <stop offset=".3" stop-color="#fff" stop-opacity=".78"></stop>
            <stop offset=".46" stop-color="#fff" stop-opacity=".88"></stop>
            <stop offset=".62" stop-color="#fff" stop-opacity=".95"></stop>
            <stop offset=".8" stop-color="#fff" stop-opacity=".99"></stop>
          ...
          <g fill="none" fill-rule="evenodd">
            ...
            <g fill="#fff" fill-rule="nonzero">
              <path
                d="m130.08 4.59v12.06h-14.3v45.75h-13.78v-45.75h-14.28v-12.06z"
              ></path>
              <path
                d="m147.62 62.4h-12.74v-45h12.74v8.62c2.41-6.07 6.28-9.67 13.17-9.23v13.32c-8.95-.7-13.17 1.5-13.17 8.71z"
              ></path>
              <path
                d="m230.4 62.76c-8.35 0-13.61-4.05-13.61-13.47v-49.29h12.83v47.53c0 2.73 1.81 3.7 4 3.7.631315.0130885 1.262786-.0169816 1.89-.09v11.09c-1.670462.4130783-3.39032.5914589-5.11.53z"
              ></path>
              <path
                d="m257.17 62.76c-8.35 0-13.6-4.05-13.6-13.47v-49.29h12.83v47.53c0 2.73 1.81 3.7 4 3.7.634638.0128631 1.269419-.0172055 1.9-.09v11.09c-1.677002.4145441-3.403668.5929326-5.13.53z"
              ></path>
              <path
                d="m268.47 39.88c0-13.9 8-23.41 21.78-23.41s21.61 9.53 21.61 23.41-7.92 23.58-21.61 23.58-21.78-9.77-21.78-23.58zm12.48 0c0 6.78 2.84 12.14 9.3 12.14s9.13-5.36 9.13-12.14-2.76-12-9.13-12-9.25 5.22-9.25 12z"
              ></path>
              <path
                d="m178 44c3.570328.3922021 7.1583.602474 10.75.63 9.75 0 18-2.62 18-12.06 0-9.17-8.47-16.07-18.66-16.07-13.72 0-22.5 10-22.5 23.85 0 14.43 7.58 23 24.71 23 5.085091.0521078 10.135127-.8466563 14.89-2.65v-10.83c-4.39 1.4-9.35 2.8-14.43 2.8-6.86 0-11.58-2.24-12.76-8.67zm9.83-17.68c3.61 0 6.51 2.45 6.51 5.8 0 4.32-4.56 5.66-9.79 5.66-2.230114-.0102442-4.456334-.1874058-6.66-.53.163357-2.1005717.762772-4.1440305 1.76-6 1.624894-3.0101722 4.749674-4.9072236 8.17-4.96z"
              ></path>
            </g>
          </g>
        </svg>
    ...
    <v-divider></v-divider>
    <div class="footer-bottom inner2">
      <div class="language">
        ...
        <select aria-label="Select a language" data-testid="language-select">
          ...
          <option value="en-AU" data-uuid="en-AU_language">English (AU)</option>
          <option value="en-GB" data-uuid="en-GB_language">English (UK)</option>
      ...
      <div class="social-media">
        ...
        >
          <svg height="12" viewBox="0 0 20 14" width="12">
            <path
              d="m12.6695433 7.17708642-4.43152592 2.43950617c-.19286329.10469136-.36604664-.03555555-.36604664-.25520987v-5.00740741c0-.22281482.17869373-.36266667.37155701-.25244445l4.46183305 2.56790124c.1971928.11259259.163737.39901234-.0358175.50765432zm7.0103835-2.87683951c0-2.37511111-1.9180056-4.30024691-4.2839264-4.30024691h-11.11168033c-2.3659208 0-4.28432007 1.9251358-4.28432007 4.30024691v5.22666667c0 2.37511112 1.91839927 4.30024692 4.28432007 4.30024692h11.11168033c2.3659208 0 4.2839264-1.9251358 4.2839264-4.30024692z"
            ></path>
          </svg>
        </v-btn>
...
hr.v-divider {
  ...
  border-color: rgb(80, 95, 121) !important;
}
...
.footer-top div.links,
.footer-top div.links div {
  padding: 1rem;
}
...
.footer-top div.links div:hover {
  background-color: rgb(52, 69, 99);
  cursor: pointer;
}

.footer-top div.links div h1 {
  font-family: "Charlie Text", sans-serif;
  font-size: 1rem;
  margin-bottom: 0.6rem;
}

.footer-top div.links div p {
  font-family: "Charlie Text", sans-serif;
  font-size: 0.75rem;
